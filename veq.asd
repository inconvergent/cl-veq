...
(asdf:defsystem #:veq
  :description "reasonably fast operations for 1d, 2d, 3d vectors and arrays of vectors."
  :version "1.0.0"
  ...
  :components ((:file "packages")
               ...
               (:file "lspace" :depends-on ("array-rows"))
               ...
               (:file "array-reduce" :depends-on ("macros" "array-rows"))
