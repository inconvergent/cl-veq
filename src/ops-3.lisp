...
(ops
  ...
  (d3sqrt (a b c)) (values (the pos-df (sqrt (pos-df a))) (the pos-df (sqrt (pos-df b))) (the pos-df (sqrt (pos-df c))))
  ...
  (f3sqrt (a b c)) (values (the pos-ff (sqrt (pos-ff a))) (the pos-ff (sqrt (pos-ff b))) (the pos-ff (sqrt (pos-ff c))))
