...
(mapcar (lambda (pair) (push pair *symbols-map*)
  ...
  `((d (&body body) `(mvc #'values ,@(ddim? body 1)))
    ...
    (flspace ((n a b &key (end t)) &body body)
             (fxlspace n a b body :end end :dim 1 :type 'ff))
    (dlspace ((n a b &key (end t)) &body body)
             (fxlspace n a b body :end end :dim 1 :type 'df))
    (f2lspace ((n a b &key (end t)) &body body)
              (fxlspace n a b body :end end :dim 2 :type 'ff))
    (d2lspace ((n a b &key (end t)) &body body)
              (fxlspace n a b body :end end :dim 2 :type 'df))
    (f3lspace ((n a b &key (end t)) &body body)
              (fxlspace n a b body :end end :dim 3 :type 'ff))
    (d3lspace ((n a b &key (end t)) &body body)
              (fxlspace n a b body :end end :dim 3 :type 'df))

    (f$lspace (n a b &key (end t)) (lspace n a b :end end :dim 1 :type 'ff))
    (d$lspace (n a b &key (end t)) (lspace n a b :end end :dim 1 :type 'df))
    (f2$lspace (n a b &key (end t)) (lspace n a b :end end :dim 2 :type 'ff))
    (d2$lspace (n a b &key (end t)) (lspace n a b :end end :dim 2 :type 'df))
