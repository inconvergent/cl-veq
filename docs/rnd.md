...
```
 ...
 ;   Source file: /home/anders/x/veq/src/rnd/2rnd.lisp
```
...
```
 ...
 ;     defined via veq:FVDEF*
 ;   Source file: /home/anders/x/veq/src/rnd/walkers.lisp
```
...
```
 ...
 ;     defined via veq:FVDEF*
 ;   Source file: /home/anders/x/veq/src/rnd/3rnd.lisp
```
...
```
 ...
 ;   Source file: /home/anders/x/veq/src/rnd/rnd.lisp
```
...
```
 ...
 ;   Source file: /home/anders/x/veq/src/rnd/macros.lisp
```
...
:missing:
 ...
 ;   [symbol]
 ; 
 ; HAMMERSLEY-PT names a compiled function:
 ;   Lambda-list: (I M N)
 ;   Derived type: (FUNCTION
...
```
 ...
 ;   [symbol]
 ; 
 ; MAKE-HALTON-GEN names a compiled function:
 ;   Lambda-list: (B &KEY (SKIP 55))
 ;   Derived type: (FUNCTION
 ;                  ((UNSIGNED-BYTE 32) &KEY (:SKIP (UNSIGNED-BYTE 32)))
 ;                  (VALUES FUNCTION &OPTIONAL))
 ;   Documentation:
 ;     make a halton sequence generator function
 ;   Source file: /home/anders/x/veq/src/rnd/rnd.lisp
```
...
```
 ...
 ;   Derived type: (FUNCTION (&OPTIONAL T) (VALUES FUNCTION &OPTIONAL))
 ;   Documentation:
 ;     random walker.
 ;   Source file: /home/anders/x/veq/src/rnd/walkers.lisp
```
...
```
 ...
 ;   Derived type: (FUNCTION (&OPTIONAL T T) (VALUES FUNCTION &OPTIONAL))
 ;   Documentation:
